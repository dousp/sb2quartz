...
import com.dou.xin.core.utils.ObjectUtil;
 ...
 */
public class BeetlGroupUtilConf extends BeetlGroupUtilConfiguration {
    ...
    public void initOther() {
        // 加载自定义函数、标签
        groupTemplate.registerFunctionPackage("objectUtil", new ObjectUtil());
